...
public abstract class JsonValue {
    ...
    private final static String TAG = "JsonValue";
    ...
    public final static int TYPE_OBJECT_ARRAY = 8;
    public final static int TYPE_NUMBER = 9;
    public final static int TYPE_NULL = 10;
    public final static int TYPE_BYTE_ARRAY = 11;
